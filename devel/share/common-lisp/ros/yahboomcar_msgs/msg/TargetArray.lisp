...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TargetArray>)))
  ...
  "d6166ed47e2fc687ee6aed6f7960f37b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TargetArray)))
  "Returns md5sum for a message object of type 'TargetArray"
  "d6166ed47e2fc687ee6aed6f7960f37b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TargetArray>)))
  ...
  (cl:format cl:nil "yahboomcar_msgs/Target[] data~%~%================================================================================~%MSG: yahboomcar_msgs/Target~%string frame_id~%time stamp~%float32 scores~%float32 ptx~%float32 pty~%float32 distw~%float32 disth~%float32 centerx~%float32 centery~%float32 distance_x~%float32 distance_y~%float32 distance~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TargetArray)))
  "Returns full string definition for message of type 'TargetArray"
  (cl:format cl:nil "yahboomcar_msgs/Target[] data~%~%================================================================================~%MSG: yahboomcar_msgs/Target~%string frame_id~%time stamp~%float32 scores~%float32 ptx~%float32 pty~%float32 distw~%float32 disth~%float32 centerx~%float32 centery~%float32 distance_x~%float32 distance_y~%float32 distance~%~%"))
