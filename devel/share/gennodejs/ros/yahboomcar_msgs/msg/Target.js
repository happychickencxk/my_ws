...
class Target {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.distance_x, buffer, bufferOffset);
    // Serialize message field [distance_y]
    bufferOffset = _serializer.float32(obj.distance_y, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.distance_x = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [distance_y]
    data.distance_y = _deserializer.float32(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '748b4a348fa0cf146876e522a8235ee4';
  }
